...
- `${CLAUDE_PLUGIN_ROOT}/templates/artifacts/proposal.md.template` — required structure for convergence
...
5. Query existing capabilities:
   ```bash
   source ${CLAUDE_PLUGIN_ROOT}/utils/openspec-cli.sh && openspec_spec_list "<name>"
   ```
