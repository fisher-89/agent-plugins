...
- Full codebase via Grep, Glob, Read for requirement traceability — the scope authority is the proposal/design declaration × the change file inventory fetched via `mcp__plugin_dev-team_dev-team__workflow_files` × the filesystem
