...
- **MUST** Use the tool `mcp__user-dev-team_mcp__test_resolve_paths` for unit test path derivation;
- **MUST** Use the tool `mcp__user-dev-team_mcp__test_detect_frameworks` for test framework identification
