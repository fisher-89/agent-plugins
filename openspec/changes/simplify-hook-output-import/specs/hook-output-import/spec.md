...
All hook files in `plugin/hooks/` SHALL import output functions from `hook_output` using direct Python import statements after adding `UTILS_DIR` to `sys.path`.
