# include-fragments Specification

## Purpose
Build-time `__INCLUDE:<id>__` fragment expansion from a single `_fragments/` root, with platform-suffixed resolve and recursive include support for shared agent/skill text.
