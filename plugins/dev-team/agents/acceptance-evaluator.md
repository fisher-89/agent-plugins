...
- Full codebase via Grep, Glob, Read for requirement traceability — the scope authority is the proposal/design declaration × the change file inventory fetched via `__MCP:workflow_files__` × the filesystem
