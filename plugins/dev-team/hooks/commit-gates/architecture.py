...
def run_gate(input_data):
    ...
    return ("deny", (
        ...
        f"  1. Invoke the archi-validate sub-agent to check dependencies against the model\n"
        f"  2. The agent will generate a report at openspec/architecture/reports/validate-<timestamp>.json\n"
